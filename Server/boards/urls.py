from .views import CommonBoardListAPIView, CommonBoardDetailAPIView, \
    RecruitmentBoardPostListAPIView, BoardMyListAPIView, RecruitmentBoardPostMyListAPIView, WholePostSearch, \
    RecruitmentBoardPostDetailAPIView, WorkerFilterView
...
urlpatterns = [
    ...
    path('commonworkerfilter/',WorkerFilterView.as_view()),
]