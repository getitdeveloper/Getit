...
// 내가 쓴 댓글 가져오기
export const MY_COMMENT_REQUEST = 'MY_COMMENT_REQUEST';
export const MY_COMMENT_SUCCESS = 'MY_COMMENT_SUCCESS';
export const MY_COMMENT_FAILURE = 'MY_COMMENT_FAILURE';
...
// 모집 게시판 게시글 상세페이지 가져오기
export const RECRUIT_POST_DETAIL_REQUEST = 'RECRUIT_POST_DETAIL_REQUEST';
export const RECRUIT_POST_DETAIL_SUCCESS = 'RECRUIT_POST_DETAIL_SUCCESS';
export const RECRUIT_POST_DETAIL_FAILURE = 'RECRUIT_POST_DETAIL_FAILURE';
